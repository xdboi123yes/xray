"""Tier 1 fast and lightweight classification model (MobileNetV2).
...
class Tier1MobileNet(BaseClassifier):
    """Tier 1 MobileNetV2 classifier implementation.

    Optimized for fast inference and low resource utilization. Implements
    uncertainty-estimation methods to comply with the BaseClassifier interface.
    """

    def __init__(self, num_classes: int = 2, pretrained: bool = True) -> None:
        """Initialize the Tier 1 MobileNetV2 model.
